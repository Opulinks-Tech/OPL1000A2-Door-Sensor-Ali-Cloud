...
typedef enum
{
    ...
    MW_FIM_IDX_GP21_PROJECT_ALIYUN_DEVICE,
...
} T_MwFim_GP21_AliyunDevice;

#define MW_FIM_GP21_ALIYUN_DEVICE_SIZE  sizeof(T_MwFim_GP21_AliyunDevice)
#define MW_FIM_GP21_ALIYUN_DEVICE_NUM   1
...
extern const T_MwFim_GP21_AliyunDevice g_tMwFimDefaultGp21AliyunDevice;
