...
SHM_DATA static void BleWifi_Ble_ServerAppGattMsgHandler_InitCfm(TASK task, MESSAGEID id, MESSAGE message)
{
...
SHM_DATA void BleWifi_Ble_AppUpdateDevName(UINT8 *name, UINT16 len)
{
