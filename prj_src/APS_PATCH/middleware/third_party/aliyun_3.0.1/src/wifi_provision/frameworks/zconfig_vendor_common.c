 ...
 * Note: ‰øÆÊîπËØ•ÂáΩ?∞Êó∂ÔºåÈ??ÉË??∞Â?Âπ≥Âè∞Â∑ÆÂ?
 * Â∫ÜÁ?Âπ≥Âè∞Ôº
 * --aws_switch_channel() ‰∏∫Á©∫
 * --zconfig_destroy()‰ºöË¢´Ë∞ÉÁî®‰∏§Ê¨°Ôºå‰?Ê¨°Ë¢´aws_main_thread_fun()Ôºå‰?Ê¨°Ë¢´Â∫ÜÁ?È©±Âä®
 * linux/rtosÂπ≥Âè∞Â∑ÆÂ?
 * --vendor_recv_80211_frame()?âÂ??∞Ô?rtosÂπ≥Âè∞ËØ•ÂáΩ?∞ÈÄöÂ∏∏‰∏∫Á©∫ÔºåÈÄöË?Ê≥®Â?callback?πÂ??∂Â?
 */
